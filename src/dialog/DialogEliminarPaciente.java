...
//        this.cedula = cedula;
    ...
    private void initComponents() {
        ...
        jLabel1.setText("Elminar Paciente");

        jLabel2.setIcon(new javax.swing.ImageIcon(getClass().getResource("/icons/groups_person_black.png"))); // NOI18N
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(DialogEliminarPaciente.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                new DialogEliminarPaciente().setVisible(true);
            }
        });
    }
